    ...
    <div class="container-fluid">
        <div class="mycontainer">
            <header class="d-flex justify-content-between mt-5">
                <h2 class="">期刊論文</h2>
                <div>
                    <a href="./journalpaper/create.php" class="btn btn-primary">新增論文</a>
                </div>
            </header>
                ...
                if($numrow != 0){
                    ...
                    while($data = mysqli_fetch_array($sqlSelect)){
                        ...
                        <tr>
                            ...
                            <td><?php echo $data['期刊名稱']; ?></td>
                            <td><?php echo $data['刊別']; ?></td>
                            <td><?php echo $data['日期']; ?></td>
                            <td class="justify-content-center">
                                <a class="btn btn-warning btn-sm m-1" href="journalpaper/edit.php?id=<?php echo $data['id']; ?>">編輯</a>
                                <a class="btn btn-danger btn-sm m-1" href="journalpaper/delete.php?id=<?php echo $data['id']; ?>">刪除</a>
                            </td>
                        </tr>
                        <?php
                        $serial++;
